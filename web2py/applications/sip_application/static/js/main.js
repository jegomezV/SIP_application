...
class StudentController {
    ...
    registerStudentController(name, email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.repository.registerStudentRepo(student);
                return student;
            }
            catch (error) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (form) {
        form.addEventListener("submit", (event) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                const student = yield controller.registerStudentController(name, email);
                ...
                if (error.message === 'The user has already been created') {
                    sweetalert2_1.default.fire({
                        icon: 'error',
                        title: 'Oops...',
